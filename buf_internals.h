...
typedef struct BufferDesc
{
	...
	int			next;			/* link in LRU queue */
	int			prev;			/* link in LRU queue */
...
/* the next and prev fileds values are either the index of 
 * next/previous buffer or one of these special values */
#define NEXT_NOT_IN_QUEUE		(-2)
#define NEXT_END_OF_QUEUE		(-1)
...
/* freelist.c */
extern void removeBufferFromLRU(BufferDesc *buf);
extern void addBufferToLRU(BufferDesc *buf);
